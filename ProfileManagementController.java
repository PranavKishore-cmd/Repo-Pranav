...
import com.payment.xborder.util.converter.profile.XBProfileManagementConverter;
...
public class ProfileManagementController {
	...
	@PostMapping("/create")
	public ResponseEntity<ProfileManagementResponse> createProfile(
			@Valid @RequestBody ProfileManagementRequest profileManagementRequest) {
	...
	public ResponseEntity<XBProfileManager> getProfile(@RequestParam(value = "companyRefId") String companyRefId) {
	...
	public ResponseEntity<List<XBProfileManager>> getAllProfiles() {
		return ResponseEntity.ok().body(profileManagementService.getAllProfiles());
	}

	@PutMapping("/updateProfile")
	public ResponseEntity<ProfileManagementResponse> updateProfile(
			@Valid @NotNull @RequestBody ProfileManagementRequest profileManagementRequest) {
		profileManagementService
				.updateProfile(ProfileManagementConverter.wsToModelUpdateProfile(profileManagementRequest));
		return new ResponseEntity<>(new ProfileManagementResponse("Profile details updated " + "successfully."),
				HttpStatus.OK);
	}

	// for new profile Page

	@PostMapping("/createXB")
	public ResponseEntity<ProfileManagementResponse> createProfileXB(
			@Valid @RequestBody ProfileManagementRequest xbProfileManagementRequest) {
		profileManagementService.createProfileXB(XBProfileManagementConverter.wsToModel(xbProfileManagementRequest));
		return new ResponseEntity<>(new ProfileManagementResponse("Profile created successfully."), HttpStatus.CREATED);
	}
