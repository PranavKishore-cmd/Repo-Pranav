...
public class PairingService {
   ...
   public void createPairing(Pairing pairing) {
	  ProfileManager profileOfReceiver = profileManagementService.getProfile(pairing.getReceiverCompanyRefId());
	  ProfileManager profileOfSender = profileManagementService.getProfile(pairing.getSenderCompanyRefId());
	  ...
	  if(docStatus)
      	pairingDao.createPairing(pairing);
	  else {
		  throw new BusinessException("Pairing cannot be done. Mismatch in the documents uploaded");
	  }
