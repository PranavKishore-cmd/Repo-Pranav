...
public class RegistrationForm {
	...
	private DateTimeFormat currentDateTime;
	private String userId; // Admin User ID
	private String emailId; // Referer/Registrat Email ID
	 ...
	 */
	public RegistrationForm(String companyId, String businessLegalName, String contactName, String businessName,
			String ifCorporateHeadquarters, String website, String federalTaxId,
			List<BeneficiaryInformationDetails> beneficiaryInformationDetailsList, String typeOfLegalEntiry,
			String controlOwnerName, String controlOwnerPhone, Address controlOwnerAddress, String title,
			String dateOfBirth, String ssn, String ownershipPercentage, String controlOwnerCountry,
			Address billingAddress, Address locationAddress, boolean isAddressSame, boolean isAdmin,
			String adminFirstName, String adminMiddleName, String adminLastName, String adminMailId,
			boolean isAuthorizer, String authorizerFirstName, String authorizerMiddleName, String authorizerLastName,
			String authorizerMailId, boolean isSaveAsDraft, CompanyStatus registrationStatus,
			DateTimeFormat currentDateTime, String userId, String emailId, boolean controlOwnerKycStatus) {
		super();
	...
	public DateTimeFormat getCurrentDateTime() {
		return currentDateTime;
	}

	public void setCurrentDateTime(DateTimeFormat currentDateTime) {
		this.currentDateTime = currentDateTime;
	}
